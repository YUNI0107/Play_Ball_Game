...
export default new Vuex.Store({
  state: {
    ...
    all_misson: [{
      ...
      {
        misson_name: "Sample：團約",
        ball: "basketball",
        misson_date: "2020-08-20",
        misson_place: "師大附中室內排球場",
        misson_time: "14:00",
        misson_location: "",
        misson_member: "Cindy、Kinda",
        desc: "後面再打一場！！",
        open: false,
        done: true,
      },
      {
        misson_name: "Sample：籃球打起來呀！",
        ball: "basketball",
        misson_date: "2020-08-21",
        misson_place: "師大籃球場",
        misson_time: "14:00",
        misson_location: "",
        misson_member: "Cindy、Kinda",
      ...
      {
        misson_name: "Sample：教學妹打球",
        ball: "volley",
        misson_date: "2020-09-07",
        misson_place: "師大附中室內排球場",
        misson_time: "14:00",
        misson_location: "",
        misson_member: "Kinda",
