...
export default {
  ...
  methods: {
    ...
    resizeGsap(){
      ...
      || (this.now_width  > 1070 && this.old_width  < 1070 && (this.old_width - this.now_width) < 0)){
        console.log('change');
        this.bg_tl.set(".ani_frontpost", {clearProps:"transform"}); 
  ...
  mounted() {
    ...
    this.axios
      .get(
        'https://newsapi.org/v2/everything?q="網球"&language=zh&apiKey=0cfedf3ca1f2486bbbc0c57d7e9639cf'
      )
      .then((res) => {
